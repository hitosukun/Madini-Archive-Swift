...
protocol ViewService: Sendable {
    ...
    /// sidebar HISTORY section's "name-on-pin" flow — the same row can
    /// carry a user-given title (e.g. "Q1 rollouts") instead of the
    /// auto-generated recent label ("source: chatgpt / 2026-04-10").
